...
${OBJECTDIR}/MediaManager.o: MediaManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include `pkg-config --cflags --cflags libv4l2` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MediaManager.o MediaManager.cpp

${OBJECTDIR}/Multimedia.o: Multimedia.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include `pkg-config --cflags --cflags libv4l2` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Multimedia.o Multimedia.cpp

${OBJECTDIR}/audio.o: audio.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include `pkg-config --cflags --cflags libv4l2` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/audio.o audio.cpp

${OBJECTDIR}/capture.o: capture.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include `pkg-config --cflags --cflags libv4l2` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/capture.o capture.cpp

${OBJECTDIR}/debug.o: debug.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include `pkg-config --cflags --cflags libv4l2` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/debug.o debug.cpp

${OBJECTDIR}/libavcodec_util.o: libavcodec_util.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include `pkg-config --cflags --cflags libv4l2` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libavcodec_util.o libavcodec_util.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include `pkg-config --cflags --cflags libv4l2` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/mypcm.o: mypcm.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include `pkg-config --cflags --cflags libv4l2` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mypcm.o mypcm.cpp
...
${TESTDIR}/tests/audioTest.o: tests/audioTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include -I. -I. `pkg-config --cflags --cflags libv4l2` -std=c++11  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/audioTest.o tests/audioTest.cpp


${TESTDIR}/tests/rawPlayer.o: tests/rawPlayer.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include -I. `pkg-config --cflags --cflags libv4l2` -std=c++11  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/rawPlayer.o tests/rawPlayer.cpp
...
${OBJECTDIR}/MediaManager_nomain.o: ${OBJECTDIR}/MediaManager.o MediaManager.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include `pkg-config --cflags --cflags libv4l2` -std=c++11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MediaManager_nomain.o MediaManager.cpp;\
	else  \
...
${OBJECTDIR}/Multimedia_nomain.o: ${OBJECTDIR}/Multimedia.o Multimedia.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include `pkg-config --cflags --cflags libv4l2` -std=c++11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Multimedia_nomain.o Multimedia.cpp;\
	else  \
...
${OBJECTDIR}/audio_nomain.o: ${OBJECTDIR}/audio.o audio.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include `pkg-config --cflags --cflags libv4l2` -std=c++11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/audio_nomain.o audio.cpp;\
	else  \
...
${OBJECTDIR}/capture_nomain.o: ${OBJECTDIR}/capture.o capture.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include `pkg-config --cflags --cflags libv4l2` -std=c++11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/capture_nomain.o capture.cpp;\
	else  \
...
${OBJECTDIR}/debug_nomain.o: ${OBJECTDIR}/debug.o debug.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include `pkg-config --cflags --cflags libv4l2` -std=c++11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/debug_nomain.o debug.cpp;\
	else  \
...
${OBJECTDIR}/libavcodec_util_nomain.o: ${OBJECTDIR}/libavcodec_util.o libavcodec_util.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include `pkg-config --cflags --cflags libv4l2` -std=c++11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libavcodec_util_nomain.o libavcodec_util.cpp;\
	else  \
...
${OBJECTDIR}/main_nomain.o: ${OBJECTDIR}/main.o main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include `pkg-config --cflags --cflags libv4l2` -std=c++11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_nomain.o main.cpp;\
	else  \
...
${OBJECTDIR}/mypcm_nomain.o: ${OBJECTDIR}/mypcm.o mypcm.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -D_DEBUG -I/usr/include/libxml2 -I. -I/usr/include/ferryfair/base -Iffmpeg_build/include `pkg-config --cflags --cflags libv4l2` -std=c++11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mypcm_nomain.o mypcm.cpp;\
	else  \
